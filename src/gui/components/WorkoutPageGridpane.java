 ...
 */
public class WorkoutPageGridpane extends GridPane
{
    final static Logger logger = Logger.getLogger(WorkoutPageGridpane.class);
    ...
    public WorkoutPageGridpane(Stage stage)
    {
        super();
